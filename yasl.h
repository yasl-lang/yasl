 ...
 */
int YASL_delstate(YASL_State *S);

/**
 * Compiles the program from file already loaded into the YASL_State.
 * @param S the YASL_State to use to compile the bytecode.
 * @return 0 on success, otherwise an error code.
 */
int YASL_compile(YASL_State *S);
 ...
 */
int YASL_declglobal(YASL_State *S, char *name);
 ...
 * @return 0 on success, else an error code.
 */
int YASL_setglobal(YASL_State *S, char *name);
 ...
 */
int YASL_pushundef(YASL_State *S);
 ...
 * @return
 */
int YASL_pushfloat(YASL_State *S, double value);
 ...
 * @return 0 on success, else error code.
 */
int YASL_pushinteger(YASL_State *S, int64_t value);
 ...
 * @return 0 on success, else error code.
 */
int YASL_pushboolean(YASL_State *S, int value);
 ...
 * @return 0 on success, else error code.
 */
int YASL_pushcstring(YASL_State *S, char *value);
 ...
 * @return 0 on success, else error code.
 */
int YASL_pushstring(YASL_State *S, char *value, int64_t size);
 ...
 * @return 0 on success, else error code.
 */
int YASL_pushcfunction(YASL_State *S, int (*value)(YASL_State *));
 ...
 */
int (*)(YASL_State) *YASL_getcfunction(YASL_Object *obj);

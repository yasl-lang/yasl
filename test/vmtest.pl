...
assert_output("echo 'hello \o world';", $RED . "SyntaxError: Invalid string escape sequence in line 1." . $END, 3);
assert_output("echo 'hello \xworld';", $RED . "SyntaxError: Invalid hex string escape in line 1." . $END, 3);

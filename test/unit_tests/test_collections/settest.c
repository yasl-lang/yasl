...
static void testsearchset(void) {
	...
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(1))), true);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(3))), true);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(2))), true);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(0))), false);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(4))), false);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(6))), false);
...
static void testunionset(void) {
	...
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(2))), true);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(0))), false);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(4))), true);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(6))), true);
...
static void testintersectionset(void) {
	...
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(1))), true);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(3))), false);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(2))), false);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(0))), false);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(4))), false);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(6))), false);
...
static void testsymmetricdifferenceset(void) {
	...
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(1))), false);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(3))), true);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(2))), true);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(0))), false);
	ASSERT_EQ(YASL_GETBOOL(YASL_Set_search(set, YASL_INT(4))), true);

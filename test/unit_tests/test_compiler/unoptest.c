...
static void test_len() {
	unsigned char expected[] = {
		...
		0x2C REG_OPT(+2), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		C_STR,
...
static void test_not() {
	unsigned char expected[] = {
		...
		0x1E REG_OPT(+1), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,

...
static Node *new_Node_0(AST nodetype, Token type, char *name /* OWN */, size_t name_len, size_t line) {
...
static Node *new_Node_1(AST nodetype, Token type, Node *child /* OWN */, char *name /* OWN */, int64_t name_len, size_t line) {
    Node *node = malloc(sizeof(Node));
    node->nodetype = nodetype;
    node->type = type;
...
static Node *new_Node_2(AST nodetype, Token type, Node *child1 /* OWN */, Node *child2 /* OWN */, char *name /* OWN */, int64_t name_len, size_t line) {
    Node *node = malloc(sizeof(Node));
    node->nodetype = nodetype;
    node->type = type;
...
static Node *new_Node_3(AST nodetype, Token type, Node *child1 /* OWN */, Node *child2 /* OWN */, Node *child3 /* OWN */, char *name /* OWN */, int64_t name_len, size_t line) {
    Node *node = malloc(sizeof(Node));
    node->nodetype = nodetype;
    node->type = type;

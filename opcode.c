...
BR_8      = 0x90, // branch unconditionally (takes next 8 bytes as jump length)
BRF_8     = 0x91, // branch if condition is falsey (takes next 8 bytes as jump length)
BRT_8     = 0x92, // branch if condition is truthy (takes next 8 bytes as jump length)
HALT      = 0xF0, // halt

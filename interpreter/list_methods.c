...
int list_copy(struct YASL_State *S) {
	if (!YASL_islist(S)) {
		YASLX_print_err_bad_arg_type(S, "list.copy", 0, "list", YASL_peektypestr(S));
		return YASL_TYPE_ERROR;
	}
...
int list___add(struct YASL_State *S) {
	if (!YASL_islist(S)) {
		YASLX_print_err_bad_arg_type(S, "list.__add", 1, "list", YASL_peektypestr(S));
		return YASL_TYPE_ERROR;
	}
	struct YASL_List *b = YASL_GETLIST(vm_pop((struct VM *) S));
	if (!YASL_islist(S)) {
		YASLX_print_err_bad_arg_type(S, "list.__add", 0, "list", YASL_peektypestr(S));
		return YASL_TYPE_ERROR;
	}
...
int list___eq(struct YASL_State *S) {
	if (!YASL_islist(S)) {
		YASLX_print_err_bad_arg_type(S, "list.__eq", 1, "list", YASL_peektypestr(S));
		return YASL_TYPE_ERROR;
	}
	struct YASL_List *right = YASL_GETLIST(vm_pop((struct VM *) S));
	if (!YASL_islist(S)) {
		YASLX_print_err_bad_arg_type(S, "list.__eq", 0, "list", YASL_peektypestr(S));
		return YASL_TYPE_ERROR;
	}
...
int list_pop(struct YASL_State *S) {
	if (!YASL_islist(S)) {
		YASLX_print_err_bad_arg_type(S, "list.pop", 0, "list", YASL_peektypestr(S));
		return YASL_TYPE_ERROR;
	}
	struct YASL_List *ls = YASL_GETLIST(vm_pop((struct VM *) S));
	if (ls->count == 0) {
...
int list_search(struct YASL_State *S) {
	...
	if (!YASL_islist(S)) {
		YASLX_print_err_bad_arg_type(S, "list.search", 0, "list", YASL_peektypestr(S));
		return YASL_TYPE_ERROR;
	}
...
int list_reverse(struct YASL_State *S) {
	if (!YASL_islist(S)) {
		YASLX_print_err_bad_arg_type(S, "list.reverse", 0, "list", YASL_peektypestr(S));
		return YASL_TYPE_ERROR;
	}
	struct YASL_List *ls = vm_poplist((struct VM *) S);
	YASL_reverse(ls);
...
int list_clear(struct YASL_State *S) {
	if (!YASL_islist(S)) {
		YASLX_print_err_bad_arg_type(S, "list.clear", 0, "list", YASL_peektypestr(S));
		return YASL_TYPE_ERROR;
	}
...
int list_sort(struct YASL_State *S) {
	if (!YASL_islist(S)) {
		YASLX_print_err_bad_arg_type(S, "list.sort", 0, "list", YASL_peektypestr(S));
		return YASL_TYPE_ERROR;
	}
	struct YASL_List *list = vm_poplist((struct VM *) S);

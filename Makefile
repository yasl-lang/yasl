...
CFLAGS=-lm -O3
OUT=YASL
OBJECTS=interpreter/VM.o interpreter/builtins/builtins.o interpreter/string8/str_methods.o interpreter/constant/constant.o interpreter/hashtable/hashtable.o interpreter/list/list.o interpreter/prime/prime.o interpreter/string8/string8.o interpreter/vtable/vtable.o

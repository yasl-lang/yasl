...
COBJECTS=compiler-c/lexer/lexer.o compiler-c/ast/ast.o compiler-c/parser/parser.o compiler-c/compiler/compiler.o compiler-c/bytebuffer/bytebuffer.o compiler-c/env/env.o hashtable/hashtable.o interpreter/YASL_Object/YASL_Object.o prime/prime.o interpreter/list/list.o interpreter/YASL_string/YASL_string.o

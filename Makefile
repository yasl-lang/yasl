...
CFLAGS=-lm -O3
OUT=YASL
OBJECTS=interpreter/VM.o interpreter/builtins/builtins.o interpreter/integer/int64_methods.o interpreter/string8/str_methods.o interpreter/list/list_methods.o interpreter/hashtable/hash_methods.o interpreter/file/file_methods.o interpreter/constant/constant.o interpreter/hashtable/hashtable.o interpreter/list/list.o interpreter/prime/prime.o interpreter/string8/string8.o interpreter/vtable/vtable.o

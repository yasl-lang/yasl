static const char *inputs[] = {
  ...
  "test/inputs/match/str_single.yasl",
  "test/inputs/match/str_back.yasl",
  "test/inputs/match/alt_nested_right.yasl",
  "test/inputs/match/let.yasl",
  "test/inputs/match/const_vlist.yasl",
  "test/inputs/match/vlist.yasl",
  "test/inputs/match/table.yasl",
  "test/inputs/match/basic_1.yasl",
  "test/inputs/match/str_dot.yasl",
  "test/inputs/match/bool.yasl",
  "test/inputs/match/undef.yasl",
  "test/inputs/match/empty.yasl",
  "test/inputs/match/basic_smallint.yasl",
  "test/inputs/match/alt_nested_left.yasl",
  "test/inputs/match/list.yasl",
  "test/inputs/match/float_smallint.yasl",
  "test/inputs/match/list_let.yasl",
  "test/inputs/match/float.yasl",
  "test/inputs/match/vtable.yasl",
  "test/inputs/match/alt.yasl",
